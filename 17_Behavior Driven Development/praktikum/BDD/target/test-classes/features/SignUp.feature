Feature:As a user I want to sign up using my email account and google So that i can login to the app
  ...
  Scenario: As user i have failed to trying to sign up with email (password does not match)
    Given I am on the sign up page
  ...
  Scenario: As user i have failed to trying to sign up with email (invalid number and valid password)
    Given I am on the sign up page
  ...
  Scenario: As user i have failed to trying to sign up with email (invalid email and valid password)
    Given I am on the sign up page
